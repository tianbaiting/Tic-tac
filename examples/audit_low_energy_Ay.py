...
PARAMETER_LABELS: dict[str, tuple[str, Any]] = {
    ...
    "p chebyshev sparseness": ("p_chebyshev_t", float),
    "p chebyshev scale": ("p_chebyshev_s", float),
    "q chebyshev sparseness": ("q_chebyshev_t", float),
    "q chebyshev scale": ("q_chebyshev_s", float),
