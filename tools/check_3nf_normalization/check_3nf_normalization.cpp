...
int main(int argc, char** argv) {
    ...
    try {
        ...
        // Expected (hand_calc_cE.py, fpi=92.2 MeV): Epelbaum A-4 contributes
        // (4π)^2 and the two Jacobi coordinates contribute (2π)^-6.
        {
            int a_3S1 = -1;
            for (int a = 0; a < pw.Nalpha; ++a) {
            ...
            if (a_3S1 >= 0) {
                ...
                std::printf("  oracle (hand_calc_cE.py, fpi=92.2) = +9.248971e-03 fm^5\n");
                double expected = +9.248970608374959e-03;
